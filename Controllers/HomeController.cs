    ...
    public class HomeController : Controller
    {
        ...
        public void Initialize()
        {
            ...
            var insetarplatillo = new Menu[]
            {
                ...
                new Menu() { NombrePlatillo = "Sushi", Descripcion = "Arroz de sushi acompañado de pescado crudo como atún o salmón, con aguacate, pepino, y servido con salsa de soja y wasabi.", Costo = 12.50, Categoria = "Entradas", RutaImagen = "../Images/Platillos/sushi.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Paella", Descripcion = "Arroz cocido con azafrán, mariscos como mejillones y gambas, pollo, chorizo, pimientos y guisantes.", Costo = 18.00, Categoria = "Entradas", RutaImagen = "../Images/Platillos/paella.jpg", Activo = 1 },
                ...
                new Menu() { NombrePlatillo = "Croissant", Descripcion = "Panadería francesa hecho de una masa laminada con mantequilla, formando una textura hojaldrada.", Costo = 3.50, Categoria = "Entradas", RutaImagen = "../Images/Platillos/croissant.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Biryani", Descripcion = "Arroz basmati cocido con pollo o cordero, yogur y una mezcla de especias como comino y cúrcuma.", Costo = 14.00, Categoria = "Entradas", RutaImagen = "../Images/Platillos/biryani.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Churrasco", Descripcion = "Carne de res asada a la parrilla, sazonada con sal gruesa y a menudo acompañada de ajo y aceite de oliva.", Costo = 22.00, Categoria = "Entradas", RutaImagen = "../Images/Platillos/churrasco.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Shakshuka", Descripcion = "Huevos escalfados en una salsa de tomates, pimientos y cebolla, condimentados con comino y pimentón.", Costo = 7.00, Categoria = "Entradas", RutaImagen = "../Images/Platillos/shakshuka.jpg", Activo = 1 },
                ...
                new Menu() { NombrePlatillo = "Ratatouille", Descripcion = "Plato de verduras guisadas como berenjena, calabacín, pimientos y tomates, sazonadas con hierbas de Provenza.", Costo = 7.50, Categoria = "Entradas", RutaImagen = "../Images/Platillos/ratatouille.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Ceviche", Descripcion = "Pescado fresco marinado en jugo de limón, mezclado con cebolla morada, cilantro, ají y acompañado de camote y maíz.", Costo = 11.00, Categoria = "Entradas", RutaImagen = "../Images/Platillos/ceviche.jpg", Activo = 1 },
                ...
                new Menu() { NombrePlatillo = "Kimchi", Descripcion = "Col fermentada con rábano, ajo, jengibre y pimiento rojo en polvo.", Costo = 4.00, Categoria = "Entradas", RutaImagen = "../Images/Platillos/kimchi.jpg", Activo = 1 },
