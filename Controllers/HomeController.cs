...
namespace Eats_Tech.Controllers
{
    public class HomeController : Controller
    {
        ...
        public void Initialize()
        {
            ...
            {
                new Categoria(){NombreCategoria = "Comida", Activo = 1},
                new Categoria(){NombreCategoria = "Bebidas", Activo = 1}
            };

            var insetarplatillo = new Menu[]
            {
                new Menu() { NombrePlatillo = "Taco al Pastor", Descripcion = "Carne de cerdo marinada en una mezcla de chiles, achiote y especias, cocinada en un trompo vertical y servida con piña, cilantro, cebolla y salsa.", Costo = 20.50, Categoria = "Comida", RutaImagen = "../Images/taco-pastor.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Taco de Carnitas", Descripcion = "Carne de cerdo cocida lentamente en su propia grasa hasta que queda tierna, generalmente acompañada de cebolla, cilantro y salsa.", Costo = 18.75, Categoria = "Comida", RutaImagen = "../Images/tacos-carnitas.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Sushi", Descripcion = "Arroz de sushi acompañado de pescado crudo como atún o salmón, con aguacate, pepino, y servido con salsa de soja y wasabi.", Costo = 12.50, Categoria = "Comida", RutaImagen = "../Images/Platillos/sushi.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Paella", Descripcion = "Arroz cocido con azafrán, mariscos como mejillones y gambas, pollo, chorizo, pimientos y guisantes.", Costo = 18.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/paella.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Pad Thai", Descripcion = "Fideos de arroz salteados con camarones o pollo, huevo, brotes de soja, cacahuetes y salsa de tamarindo.", Costo = 15.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/pad-thai.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Pizza Margherita", Descripcion = "Pizza con una base de masa delgada, salsa de tomate, mozzarella fresca y albahaca.", Costo = 10.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/pizza-margarita.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Croissant", Descripcion = "Panadería francesa hecho de una masa laminada con mantequilla, formando una textura hojaldrada.", Costo = 3.50, Categoria = "Comida", RutaImagen = "../Images/Platillos/croissant.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Biryani", Descripcion = "Arroz basmati cocido con pollo o cordero, yogur y una mezcla de especias como comino y cúrcuma.", Costo = 14.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/biryani.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Churrasco", Descripcion = "Carne de res asada a la parrilla, sazonada con sal gruesa y a menudo acompañada de ajo y aceite de oliva.", Costo = 22.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/churrasco.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Shakshuka", Descripcion = "Huevos escalfados en una salsa de tomates, pimientos y cebolla, condimentados con comino y pimentón.", Costo = 7.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/shakshuka.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Poutine", Descripcion = "Papas fritas cubiertas con queso en grano y salsa gravy.", Costo = 9.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/poutine.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Ratatouille", Descripcion = "Plato de verduras guisadas como berenjena, calabacín, pimientos y tomates, sazonadas con hierbas de Provenza.", Costo = 7.50, Categoria = "Comida", RutaImagen = "../Images/Platillos/ratatouille.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Ceviche", Descripcion = "Pescado fresco marinado en jugo de limón, mezclado con cebolla morada, cilantro, ají y acompañado de camote y maíz.", Costo = 11.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/ceviche.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Kebab", Descripcion = "Carne de cordero o pollo marinada en yogur y especias, cocida a la parrilla y servida en pan pita.", Costo = 8.50, Categoria = "Comida", RutaImagen = "../Images/Platillos/kebab.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Kimchi", Descripcion = "Col fermentada con rábano, ajo, jengibre y pimiento rojo en polvo.", Costo = 4.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/kimchi.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Bratwurst", Descripcion = "Salchicha de cerdo a la parrilla, servida en un pan con mostaza y chucrut.", Costo = 6.50, Categoria = "Comida", RutaImagen = "../Images/Platillos/bratwurst.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Falafel", Descripcion = "Bolitas fritas de garbanzo, ajo, cebolla y especias, servidas en pan pita con salsa de yogur.", Costo = 6.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/falafel.jpg", Activo = 1 },
                new Menu() { NombrePlatillo = "Pho", Descripcion = "Sopa de fideos de arroz con caldo de ternera, ternera o pollo, hierbas frescas y brotes de soja.", Costo = 11.00, Categoria = "Comida", RutaImagen = "../Images/Platillos/pho.jpg", Activo = 1 }
